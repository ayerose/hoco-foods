jQuery.fn.ratingStars = function( options ) {
    ...
    var methods = {
        ...
        onStarEnter: function(starElement, container) {
            ...
            $.each($(".rating-stars-container .rating-star"), function(index, element) {
                if(i <= elementIndex) {
        ...
        onStarLeave: function(starElement, container) {
            ...
            $(".rating-stars .rating-stars-container .rating-star").removeClass(settings.selectors.starHoverClass);
            $(".rating-stars .rating-stars-container .rating-star").removeClass(settings.selectors.starNoHoverClass);
        ...
        onStarSelected: function(starElement, container) {
            ...
            $(".rating-stars-container .rating-star").removeClass(settings.selectors.starActiveClass);
            ...
            $(container).find(settings.selectors.targetFormElementSelector).val(elementIndex + 1);
